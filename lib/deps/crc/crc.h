...
#ifdef CRC8_REDUCE_FOOTPRINT //Can be set in order to avoid crc8 table into compiled
...
#else
static unsigned char crc8_table[] = {0x00, 0x07, 0x0e, 0x09, 0x1c, 0x1b, 0x12, 0x15,
